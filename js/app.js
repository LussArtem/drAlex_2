            ...
            if (wrapper && !isMobile.any()) {
                ...
                function mouseActions(e) {
                    if (e.type === "mouseout") cursor.style.opacity = 0; else if (e.type === "mousemove") {
                        ...
                        if (e.target.closest("button") && !e.target.closest("._tab-active") || e.target.closest("a") && !e.target.closest("._active") || e.target.closest("input") || e.target.closest("[data-gallery]") || window.getComputedStyle(e.target).cursor !== "none" && window.getComputedStyle(e.target).cursor !== "default") cursor.classList.add("_hover"); else cursor.classList.remove("_hover");
...
***************************************************************************** */
        ...
        if (document.getElementById("masonry")) if (document.documentElement.clientWidth >= 1024) {
        ...
        if (document.getElementById("masonryPlaylist")) if (document.documentElement.clientWidth >= 1024) {
            new Masonry(document.getElementById("masonryPlaylist"), {
                gap: 30,
                columns: 2
            });
        } else {
